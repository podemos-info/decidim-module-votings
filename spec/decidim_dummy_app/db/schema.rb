...
ActiveRecord::Schema.define(version: 20_171_127_115_686) do
  ...
  create_table 'decidim_budgets_orders', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_feature_id], name: 'decidim_budgets_order_user_feature_unique', unique: true
  ...
  create_table 'decidim_features', id: :serial, force: :cascade do |t|
    ...
    t.index %w[participatory_space_id participatory_space_type], name: 'index_decidim_features_on_decidim_participatory_space'
  end
  ...
  create_table 'decidim_user_groups', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_organization_id document_number], name: 'index_decidim_user_groups_document_number_on_organization_id', unique: true
    t.index %w[decidim_organization_id name], name: 'index_decidim_user_groups_names_on_organization_id', unique: true
  end
  ...
  create_table 'decidim_users', id: :serial, force: :cascade do |t|
    ...
    t.index %w[email decidim_organization_id], name: 'index_decidim_users_on_email_and_decidim_organization_id', unique: true, where: '((deleted_at IS NULL) AND (managed = false))'
